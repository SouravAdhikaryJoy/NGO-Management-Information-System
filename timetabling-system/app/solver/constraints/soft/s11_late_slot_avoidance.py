...
class LateSlotAvoidance(SoftConstraint):
    key = "S11_late_slot_avoidance"
    description = "Penalise sessions occupying the last slot of a day."
    ...
    def raw_penalty(self, problem, timetable):
        ...
        for session_id, placement in timetable.placements.items():
            ...
            if placement.index <= indexes[-1] < placement.index + s.duration:
                penalty += 1
